            ...
            for i in range(0, len(board.diamonds)):
                if board.diamonds[i].properties.points == 1:
                    ...
                    if distance_to_diamond < temp_distance:
                        if distance_to_base < distance_to_diamond:
                            print(Fore.RED + "BASE DEKAT, DMND 4" + Style.RESET_ALL)
                            print(Fore.CYAN + f'base: {base}')
                            print(Fore.CYAN + f'dmnd: {diamond_position}')
